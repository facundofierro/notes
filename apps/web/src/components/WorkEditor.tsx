...
export function WorkEditor({
  ...
  return (
    <div className="flex w-full h-full">
      ...
      <div className={`flex overflow-hidden flex-col bg-background border-l border-border transition-all duration-300 ${ (rightSidebarView === "terminal" && isTerminalRunning) || rightSidebarView === "iframe" ? "w-[50%]" : "w-[360px]" }`}>
        {/* Terminal View */}
