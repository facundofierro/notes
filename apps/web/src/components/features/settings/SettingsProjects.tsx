...
import { Trash2, Folder, FolderTree, Plus } from "lucide-react";
import { ProjectConfig, UserSettings } from "@/hooks/use-settings";
  ...
  return (
    <div className="space-y-6">
      <DirectoryPicker
        ...
        title={
          newType === "folder" ? "Select Projects Folder" : "Select Project"
        }
      />
