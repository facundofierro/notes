...

{
  ...
  try {
    ...
    ensureEnvFileMissingOnly(dir, { OPENAI_API_KEY: "sk-new" });
    assert.equal(fs.readFileSync(envPath, "utf8"), "OPENAI_API_KEY=sk-existing\n");

    ensureEnvFileMissingOnly(dir, { ANTHROPIC_API_KEY: "sk-ant" });
